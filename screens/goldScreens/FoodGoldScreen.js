...
import FoodGoldContent from './GoldContentScreens/FoodGoldContent';
import DeliveryHotelDetails from '../orderScreens/DeliveryHotelDetails';
import {createStackNavigator , createAppContainer} from 'react-navigation';

const FoodGoldScreen=createStackNavigator({
    FoodGoldContent:{
        screen:FoodGoldContent
    },
...
const Container=createAppContainer(FoodGoldScreen);
